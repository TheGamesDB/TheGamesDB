	...
	<div id="gameHead">
		...
		?>
				<?php
					...
					case "locked":
						?>
						<h2 style="color: #FF4F00;">Locked Games</h2>
						...
						?>
							<tr>
								<td colspan="4" style="font-weight: bold;">Total Locked Games: <?php echo $lockedcount; ?></td>
							</tr>
						</table>
						<?php
						break;
					...
					case "missingplatform":
						?>
						<h2 style="color: #FF4F00;">Games Missing Platform Data</h2>
						<table align="center" border="1" cellspacing="0" cellpadding="7">
							<tr>
								<th style="background-color: #333; color: #FFF;">Game ID</th>
								<th style="background-color: #333; color: #FFF;">Game Title</th>
						...
						?>
							<tr>
								<td colspan="2" style="font-weight: bold;" >Total Games Missing Platform Data: <?php echo $missingcount; ?></td>
							</tr>
						</table>
						<?php
						break;
					...
					case "multipleplatform":
						?>
						<h2 style="color: #FF4F00;">Games With Multiple Platforms</h2>
						<table align="center" border="1" cellspacing="0" cellpadding="7">
							<tr>
								<th style="background-color: #333; color: #FFF;">Game ID</th>
								<th style="background-color: #333; color: #FFF;">Game Title</th>
						...
						?>
							<tr>
								<td colspan="3" style="font-weight: bold;" >Total Games With Multiple Platforms: <?php echo $multiplecount; ?></td>
							</tr>
						</table>
						<?php
						break;
					...
					case "morefront":
						?>
						<h2 style="color: #FF4F00;">Games With 2 or More Front Boxart</h2>
						<table align="center" border="1" cellspacing="0" cellpadding="7">
							<tr>
								<th style="background-color: #333; color: #FFF;">Game ID</th>
								<th style="background-color: #333; color: #FFF;">Game Title</th>
						...
						?>
							<tr>
								<td colspan="3" style="font-weight: bold;" >Total Games With 2 or More Front Boxart: <?php echo $morecount; ?></td>
							</tr>
						</table>
						<?php
						break;
				...
				// End Admin Only Stats & Reports
					switch ($StatsType)
					{
						case "missingoverview":
							...
							<h2 style="color: #FF4F00;">Games Missing Overview</h2>
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Overview: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
						...
						case "missinggenre":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Genre Data</h2>
							<!-- Start Sort By -->
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Genre Data: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
							...
							case "missingfront":
								...
								$limit = $pagResult["limit"];
								?>
								<h2 style="color: #FF4F00;">Games Missing Front Boxart</h2>
								<!-- Start Sort By -->
								<form style="text-align: right;">
									<input type="hidden" name="tab" value="<?=$tab?>" />
									<input type="hidden" name="statstype" value="<?=$statstype?>" />
								...
								?>
									<tr>
										<td colspan="3" style="font-weight: bold;" >Total Games Missing Front Boxart: <?php echo $total; ?></td>
									</tr>
								</table>
								<?=$pagination?>
								<?php
						...
						case "missingback":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Back Boxart</h2>
							<!-- Start Sort By -->
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Back Boxart: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
						...
						case "missingfanart":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Fanart</h2>
							<!-- Start Sort By -->
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Fanart: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
						...
						case "missingbanner":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Banners</h2>
							<!-- Start Sort By -->
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
							...
							case "missingscreenshot":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Screenshots</h2>
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
								<p style="font-weight: bold;">Sort By: <select name="sortBy" onchange="this.form.submit();">
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Screenshots: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
							...
							case "missingyoutube":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Games Missing Youtube Trailers</h2>
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
								<p style="font-weight: bold;">Sort By: <select name="sortBy" onchange="this.form.submit();">
							...
							?>
								<tr>
									<td colspan="3" style="font-weight: bold;" >Total Games Missing Youtube Trailers: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
							...
							case "topratedgames":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Top Rated Games</h2>
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
								<p style="font-weight: bold;">Sort By: <select name="sortBy" onchange="this.form.submit();">
							...
							?>
								<tr>
									<td colspan="4" style="font-weight: bold;" >Total Top Rated Games: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
							...
							case "topratedfanart":
								...
								$limit = $pagResult["limit"];
							?>
							<h2 style="color: #FF4F00;">Top Rated Fanart</h2>
							<form style="text-align: right;">
								<input type="hidden" name="tab" value="<?=$tab?>" />
								<input type="hidden" name="statstype" value="<?=$statstype?>" />
								<p style="font-weight: bold;">Sort By: <select name="sortBy" onchange="this.form.submit();">
							...
							?>
								<tr>
									<td colspan="5" style="font-weight: bold;" >Total Top Rated Fanart: <?php echo $total; ?></td>
								</tr>
							</table>
							<?=$pagination?>
							<?php
