<!-- Start Site News -->
<div id="news" style="text-align: justify; width: 578px; float: left;">
	<?php include("sitenews.php"); ?>
</div>
<!-- End Site News -->

<div id="sidebar" style="margin-left: 15px; padding-left: 15px; padding-bottom: 15px; border-left: 2px dotted #333; border-bottom: 2px dotted #333; float: left;">
