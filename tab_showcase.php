...
<div style="width: 800px; background-color: #000; color: #FFF; margin: auto; padding: 5px 30px 15px 30px; border: 2px solid #666; outline: 0px solid #666; text-align: justify; background-image: url(images/showcase/bg-featured-panel.jpg); background-repeat: no-repeat; background-position: bottom center; border-radius: 25px; outline-radius: 25px; margin-bottom: 20px;">
	...
	<p>GameBrowser uses our API as a source for game artwork &amp; metadata, enabling users to have a media-rich and informative way of browsing their collection.</p>
	
	<div style="clear: both;"></div>
	
	<div style="float: left; width: 315px;">
		<h2 class="arcade" style="color: #FF004F;">Info:</h2>
		<p><strong>Type:</strong> MediaBrowser Add-On</p>
		<p><strong>GameBrowser:</strong> <a href="http://www.gamebrowser.tv" target="_blank" style="color: #FFFFFF;">www.gamebrowser.tv</a></p>
		<p><strong>MediaBrowser:</strong> <a href="http://www.mediabrowser.tv" target="_blank" style="color: #FFFFFF;">www.mediabrowser.tv</a></p>
	</div>
...
<div style="width: 800px; background-color: #000; color: #FFF; margin: auto; padding: 5px 30px 15px 30px; border: 2px solid #666; outline: 0px solid #666; text-align: justify; background-image: url(images/showcase/bg-featured-panel.jpg); background-repeat: no-repeat; background-position: bottom center; border-radius: 25px; outline-radius: 25px; margin-bottom: 20px;">
	...
	<div style="float: left; width: 315px;">
		...
		<p><strong>Project:</strong> <a href="http://code.google.com/p/xbmc-launcher/" target="_blank" style="color: #FFFFFF;">code.google.com/p/xbmc-launcher/</a></p>
	</div>
...
<div style="width: 800px; background-color: #000; color: #FFF; margin: auto; padding: 5px 30px 15px 30px; border: 2px solid #666; outline: 0px solid #666; text-align: justify; background-image: url(images/showcase/bg-featured-panel.jpg); background-repeat: no-repeat; background-position: bottom center; border-radius: 25px; outline-radius: 25px; margin-bottom: 20px;">
	...
	<div style="float: left; width: 315px;">
		...
		<p><strong>Type:</strong> XBMC Add-On</p>
		<p><strong>XBMC:</strong> <a href="http://xbmc.org/" target="_blank" style="color: #FFFFFF;">http://xbmc.org/</a></p>
		<p><strong>Project:</strong> <a href="http://code.google.com/p/romcollectionbrowser/" target="_blank" style="color: #FFFFFF;">code.google.com/p/romcollectionbrowser/</a></p>
	</div>
