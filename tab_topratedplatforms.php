...
<div id="gameWrapper">
	...
	<h1>Top 10 Rated Platforms</h1>
	
	<?php
		$recentResult = mysql_query(" SELECT p.*, AVG(r.rating) toprating FROM platforms AS p, ratings AS r WHERE r.itemid = p.id AND r.itemtype = 'platform' GROUP BY p.id ORDER BY toprating DESC LIMIT 10; ");
		$count = 1;
